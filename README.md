...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/tokenmaxed/pongo2/v7)](https://pkg.go.dev/github.com/tokenmaxed/pongo2/v7)
...
```sh
go get -u github.com/tokenmaxed/pongo2/v7
```
...
- [Easy API to create new filters and tags](https://pkg.go.dev/github.com/tokenmaxed/pongo2/v7#RegisterFilter) ([including parsing arguments](https://pkg.go.dev/github.com/tokenmaxed/pongo2/v7#Parser))
- Additional features:
  ...
  - [Template sandboxing](https://pkg.go.dev/github.com/tokenmaxed/pongo2/v7#TemplateSet) ([directory patterns](http://golang.org/pkg/path/filepath/#Match), banned tags/filters)
